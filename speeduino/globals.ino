...
const uint16_t npage_size[NUM_PAGES] = {0,128,288,288,128,288,128,240,192,192,192,288,192,128,288,48}; /**< This array stores the size (in bytes) of each configuration page */
...
struct table3D predictedMapTable; //6x6 Predicted MAP (for AE) map
